...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FBIOS;FBAV/166.0.0.53.95;FBBV/515349676;FBDV/iPhone10,4;FBMD/iPhone;FBSN/iOS;FBSV/11;FBSS/2;FBCR/Djezzy;FBID/phone;FBLC/fr_FR;FBOP/45;FBRV/102694127]"
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=80) as zain:
			clear()
			tl = str(len(user))
